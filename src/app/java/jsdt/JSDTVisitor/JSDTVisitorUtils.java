...
class JSDTVisitorUtils {
	...
	static JolieTypeJavaInfo getJavaInfo( NativeType nativeType ) {
		switch( nativeType ) {
		case VOID:
		...
		case STRING:
			return new JolieTypeJavaInfo( "String", "isString", "strValue" );
		case DOUBLE:
		...
		case ANY:
			return new JolieTypeJavaInfo( "Object", "isDefined", "valueObject" );
		}
		return null;
	}
